    ...
    <div className={classes.plate}>
		...
		<div className={classes.info}>
			...
			<div className={classes.teh}>
				<div className={classes['teh-item']}><span>Area:</span> {props.items.area}</div>
				<div className={classes['teh-item']}><span>Number of rooms:</span> {props.items.rooms}</div>
				<div className={classes['teh-item']}><span>Floor:</span> {props.items.floor}</div>
				<div className={classes['teh-item']}><span>Year:</span> {props.items.year}</div>
			</div>
